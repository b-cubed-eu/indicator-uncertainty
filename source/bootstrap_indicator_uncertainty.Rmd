...
```{r}
insect_eveness_df$effect <- classification(
  lcl = insect_eveness_df$ll,
  ucl = insect_eveness_df$ul,
  threshold = 0.1,
  reference = 0.6)

insect_eveness_df$effect_coarse <- coarse_classification(
  insect_eveness_df$effect)
