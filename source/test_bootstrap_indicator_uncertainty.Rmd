...
ci_df <- get_bootstrap_ci_old(bootstrap_insect_data, h = logit, hinv = inv_logit)
...
# Calculate confidence intervals
ci_df2 <- get_bootstrap_ci_old(bootstrap_insect_data2, h = logit, hinv = inv_logit,
...
# Calculate confidence intervals
ci_df3 <- get_bootstrap_ci_old(bootstrap_insect_data3, h = logit, hinv = inv_logit,
                           type = c("norm", "basic", "perc", "bca"))
...
> Transformation is not a good idea, eveness can be 0 or 1
> ...
