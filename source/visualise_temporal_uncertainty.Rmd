...
Create figures for temporal uncertainty. Based on [this tutorial](https://b-cubed-eu.github.io/dubicube/articles/visualising-temporal-trends.html).
...
# Visualise
p1 <- plot(impact_indicator)
p2 <- plot(impact_indicator, trend = "line")
p3 <- plot(impact_indicator, trend = "smooth")
```
